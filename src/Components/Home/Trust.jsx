...
export default function TrustedSection() {
  ...
  return (
    <section className="bg-[#020617] py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-12 flex justify-center">
      ...
      {/* Card */}
      <div className="relative w-full max-w-7xl rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl px-5 sm:px-8 md:px-12 py-8 sm:py-10 md:py-10 text-center overflow-hidden">
